...
| `page_download_attachment` | Прочитать содержимое вложения прямо в ответе — UTF-8 как текст, остальное в base64; до 1 MiB, больше — отказ с отсылкой на `download_url` |
...
| `page_edit` | Правка содержимого точными заменами текста без пересылки всей страницы; ненайденное или неоднозначное совпадение роняет вызов до того, как что-либо записано |
