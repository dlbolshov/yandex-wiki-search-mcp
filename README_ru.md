...
| `page_download_attachment` | Прочитать содержимое вложения прямо в ответе, embedded resource — текст как текст, остальное base64-блобом; до 128 KiB, больше — отказ ещё до передачи, с отсылкой на `download_url` |
