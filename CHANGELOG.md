...
- The platform-conditional branches carry `# pragma: no cover` with their reasons, so the 100% gate is reachable on every leg of the OS matrix rather than on none of them
